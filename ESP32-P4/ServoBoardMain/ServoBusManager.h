...
static constexpr uint16_t SERVO_TARGET_SPEED_DEFAULT = 3000;
static constexpr uint8_t SERVO_TARGET_ACC_DEFAULT = 200;
...
public:
    ...
    void setTarget(
        uint8_t id,
        int16_t position,
        uint16_t speed = SERVO_TARGET_SPEED_DEFAULT,
        uint8_t acc = SERVO_TARGET_ACC_DEFAULT
    );
